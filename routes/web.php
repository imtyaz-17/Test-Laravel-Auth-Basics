...
Route::get('profile', [\App\Http\Controllers\ProfileController::class, 'show'])->midleware('auth')->name('profile.show');
Route::put('profile', [\App\Http\Controllers\ProfileController::class, 'update'])->midleware('auth')->name('profile.update');
